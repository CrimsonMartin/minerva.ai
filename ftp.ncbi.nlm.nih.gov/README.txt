...
Baseline Data
-------------
NLM produces a baseline set of PubMed citation records in XML format for download on an annual basis. The annual baseline is released in December of each year. The complete baseline consists of files pubmed24n0001.xml through pubmed24n1219.xml.
ftp://ftp.ncbi.nlm.nih.gov/pubmed/baseline 

Daily Update Files
------------------
Each day, NLM produces update files that include new, revised, and deleted citations. The first Update file to be loaded after loading the complete set of 2024 PubMed Baseline files is pubmed24n1220.xml. 
...
https://dtd.nlm.nih.gov/ncbi/pubmed/doc/out/240101/index.html
